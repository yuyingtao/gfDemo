...
var useElecLoadKPIRender = {
    ...
    initTime: function initTime() {
        ...
        // 格式化，最大和最小间隔
        var patterns = { name: 'yyyy-MM-dd', min: 20 * onDay, reduce: 0 //日：默认显示15天(reduce)，最多显示30天(min)
        };var initNewDate = new Date(); //今天的日期
        var initAddmin = initNewDate.pattern(patterns.name);
        var initCurTime = new Date(+initNewDate - patterns.reduce).pattern(patterns.name);
