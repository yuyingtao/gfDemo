...
var spPower = {
    ...
    curvePowerKpi: function (datas) {
        var xData = datas.xData, yData1 = datas.yData1, yData2 = datas.yData2, yData3 = [];
        for(var i = 0,len = yData1.length;i<len;i++){
            if(i<5){
                yData1[i] ? yData3.push(+yData1[i]+0.5) : yData3.push(null)
            }else{
                yData1[i] ? yData3.push(+yData1[i]+Math.floor(Math.random()*4+1)) : yData3.push(null)
            }
        ...
        var option = {
            tooltip: {
                ...
                formatter: function (item) {
                    ...
                    if (item[1].data != 'null') {
                        str += '<div style="color: #333">' + item[1].seriesName + ': <span style="font-size: 1.3em">' + item[1].data + '</span></div>'
                    } else {
                        // str +=  '<div style="color: #a5e2f9">'+item[1].seriesName+': <span style="font-size: 1.3em"></span>'+datas.unit+'</div>'
                        str += ''
                    }
                    str += '<div style="color: #333">' + item[2].seriesName + '('+datas.unit+'): <span style="font-size: 1.3em">' + item[2].data + '</span></div>'
                ...
                areaStyle: {
                    normal: {
                        color: {
                            ...
                            colorStops: [{
                                offset: 0,
                                color: 'rgba(17,188,218, .2)',
                            }, {
                                offset: 1,
                                color: 'rgba(17,188,218, 0)',
                            }],
                            globalCoord: false
                        },
                    }
