...
var spProfit = {
    ...
    //发电量及收益实时数据  光伏
    singleGP: function singleGP(datas) {
        var genDay = App.ConvertUnit({
            unit: 'kilowatt',
            num: datas.genDay,
            len: 6,
            split: 4,
        ...
        var profitTotal = App.ConvertUnit({
            unit: 'rmb',
        ...
        $('#sp-profitDay').text(datas.profitDay + datas.profitDayUnit);
        $('#sp-genTotal').text(genTotal.num + genTotal.unit);
        $('#sp-profitTotal').text(datas.profitTotal + datas.profitTotalUnit);
    },
    //发电量及收益实时数据  光储
    drawGcData: function drawGcData(datas) {
        var genDay = App.ConvertUnit({
            unit: 'kilowatt',
            num: datas.genDay,
            len: 6,
        ...
        var dischargeDay = App.ConvertUnit({
            unit: 'kilowatt',
    ...
    //发电量及收益实时数据  储能
    drawCnData: function drawCnData(datas) {
        var dischargeDay = App.ConvertUnit({
            unit: 'kilowatt',
            num: datas.dischargeDay,
            len: 6,
    ...
    //光伏水波图
    gfWaterWave: function gfWaterWave() {
        var _this = this;
    ...
    //储能水波图
    cnWaterWave: function cnWaterWave() {
        var _this = this;
    ...
    //光储水波图
    gcWaterWave: function gcWaterWave() {
        var _this = this;
