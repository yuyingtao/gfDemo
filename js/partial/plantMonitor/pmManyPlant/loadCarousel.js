...
var loadCarouselRender = {
        ...
        $.http.POST('/system/getPropagandaPhoto.do', { tokenId: Cookies.getCook('tokenId') }, function (res) {
            ...
            if (!res.body.length) {
                ...
                if (res.body.length == "1") {
                    ...
                    var elDiv = res.body.map(function (item, index) {
                        if (index == "0") {
    ...
    //获取电站信息
    getPlantsData: function getPlantsData(_this) {
        //基础信息
        getGetPlantsData();
        function getGetPlantsData() {
            ...
            $.http.POST('/monitor/getTotalInfo.do', { tokenId: Cookies.getCook('tokenId') }, function (res) {
                if (res.code == "100") {
                    ...
                    var totalPower = App.ConvertUnit({
                        unit: 'kilowatt',
                        num: body.totalPower,
                        len: 6,
                        split: 4,
                    ...
                    var totalPrice = App.ConvertUnit({
                        unit: 'rmb',
                        num: body.totalPrice,
                        len: 6,
                        split: 4,
        ...
        function totalData() {
            ...
            $.http.POST('/monitor/getTotalPhotovoltaic.do', { tokenId: Cookies.getCook('tokenId'), plantType: Cookies.getCook('plantType') }, function (res) {
                ...
                if (JSON.stringify(res.body) == "{}") {
                    ...
                    var totalCapacity = App.ConvertUnit({
                        unit: 'kilowatt',
                        num: body.totalCap,
                        len: 6,
                        split: 4,
                    ...
                    var totalElectricity = App.ConvertUnit({
                        unit: 'watt',
                    ...
                    var totalPhoCap = App.ConvertUnit({
                        unit: 'watt',
