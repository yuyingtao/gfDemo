...
var photovoltaicTable = {
    ...
    Render: function Render() {
        var _this = this;
        _this.tableInter && clearTimeout(_this.tableInter);
    ...
    getArea: function getArea() {
        ...
        $('#choosePower').unbind('click').on('click', function () {
            //当前区域下范围查找
            rangePlant();
        });
        $('.searchPlantInfo').unbind('click').on('click', function () {
            //当前区域下范围下查找关键字
            conditionPlant();
        });
        ...
        function refreshTable(obj) {
            ...
            _this.plantTable = $('#plantTable').dataTable({
                ...
                'drawCallback': function drawCallback(set) {
                    if (main.clearInterCharge(_this.tableInter, _this.domId)) return;
                    _this.tableInterStop = false;
                    _this.tableInter = setTimeout(function () {
                ...
                columns: [{ data: "name", title: $.getI18n('plantName'), width: '14%', render: function render(data, type, full, meta) {
                        return '<div class="td-noWrap td-plantName" title="' + data + '">' + '<i><img src="/images/pmImages/arrow_1.png" alt=""></i>' + data + '</div>';
                    } }, { data: "addr", title: $.getI18n('address'), width: '12%', render: function render(data, type, full, meta) {
                        return '<div class="td-noWrap" title="' + data + '">' + data + '</div>';
                    } }, { data: "capacity", title: $.getI18n('plantMon.capacity') + '(千瓦)', width: '7%' }, { data: "weather", title: $.getI18n('screen.weather'), width: '7%', render: function render(data) {
                        return '<image src="' + data + '" style="width: 30px; height: 30px"></image>';
                    } }, { data: "status", title: $.getI18n('status'), width: '10%', render: function render(data, type, full, meta) {
                        if (data == '0') {
                    ...
                    } }, { data: "genDay", title: $.getI18n('genToday') + '(度)', width: '11%' }, { data: "genTotal", title: $.getI18n('totalPowerGen') + '(度)', width: '11%' }, { data: "ppr", title: $.getI18n('ppr') + '(小时)', width: '10%' }, { data: "contacts", title: $.getI18n('contacts'), width: '9%' }, { data: "contectsTel", title: $.getI18n('telephone'), width: '8%' }],
                "order": [
                    // [2, "desc"]
                ],
                'columnDefs': [{
                    ...
                    function plantInfoById() {
                        $.http.POST('/monitor/plantOpen.do?tokenId=' + Cookies.getCook('tokenId'), { plantId: id }, function (res) {
                            ...
                            !!value ? $('.detailBox img').attr('src', value).one('error', function () {
                                $('.detailBox img').attr('src', '/images/defaultPlant.png');
                            }) : $('.detailBox img').attr('src', '/images/defaultPlant.png');
    ...
    //储能电站获取电站列表
    getStoPlantTable: function getStoPlantTable() {
        var _this = this;
        function refreshArea(data) {
            $.http.POST('/report/getAreaDistribution.do', data, function (result) {
                setCurArea(result.body.areaInfo);
        ...
        function refreshTable(obj) {
            ...
            _this.plantTable = $("#plantTable").dataTable({
                ...
                "headerCallback": function headerCallback(thead, data, start, end, display) {
                    ...
                    _status && $('#status').val(_status);
                    //电站类型
                    var typeStr = '            <select name="plantType" id="plantType" style="width: 84%">\n' + '                <option value="">类型</option>\n' +
                ...
                columns: [{ data: "name", title: $.getI18n('plantName'), width: '14%', render: function render(data, type, full, meta) {
                        ...
                        return '<div class="td-noWrap" title="' + data + '">' + data + '</div>';
                    } }, { data: "capacity", title: $.getI18n('plantMon.capacity') + '(度)', width: '7%' }, { data: "plantType", title: $.getI18n('alarmType'), width: '9%' }, { data: "status", title: $.getI18n('status'), width: '8%', render: function render(data, type, full, meta) {
                        if (data == '0') {
                            return '<i class="cl1"></i><span class="cl1">' + $.getI18n('gen') + '</span>';
                        } else if (data == '1') {
                            return '<i class="cl2"></i><span class="cl2">' + $.getI18n('standby') + '</span>';
                    ...
                    } }, { data: "weather", title: $.getI18n('screen.weather'), width: '7%', render: function render(data) {
                        return '<image src="' + data + '" style="width: 30px; height: 30px"></image>';
                    } }, { data: "charToday", title: $.getI18n('chargeToday') + '(度)', width: '11%' }, { data: "disCharToday", title: $.getI18n('dischargeToday') + '(度)', width: '11%' }, { data: "soc", title: 'SOC', width: '10%' }, { data: "sysEfficiency", title: $.getI18n('sysEfficiency'), width: '9%' }],
                "order": [
                    // [2, "desc"]
                ],
                'columnDefs': [{
    ...
    //光储电站获取电站列表
    getOptStoPlantTable: function getOptStoPlantTable() {
        var _this = this;
        function refreshArea(data) {
            $.http.POST('/report/getAreaDistribution.do', data, function (result) {
                setCurArea(result.body.areaInfo);
        ...
        function refreshTable(obj) {
            ...
            _this.phoTable = $('#phoTable').dataTable({
                ...
                columns: [{ data: "plantName", title: $.getI18n('plantName'), width: '12%', render: function render(data, type, full, meta) {
                        return '<div class="td-noWrap td-plantName" title="' + data + '">' + '<i><img src="/images/pmImages/arrow_1.png" alt=""></i>' + data + '</div>';
                    } }, { data: "plantAddr", title: $.getI18n('address'), width: '10%', render: function render(data, type, full, meta) {
                        return '<div class="td-noWrap" title="' + data + '">' + data + '</div>';
                    } }, { data: "power", title: $.getI18n('ass.power') + '(兆瓦)', width: '7%' }, { data: "status", title: $.getI18n('status'), width: '5%', render: function render(data, type, full, meta) {
                        if (data == '0') {
                            return '<i class="cl1"></i><span class="cl1">' + $.getI18n('gen') + '</span>';
                        } else if (data == '1') {
                            return '<i class="cl2"></i><span class="cl2">' + $.getI18n('standby') + '</span>';
                        ...
                        return '<image src="' + data + '" style="width: 30px; height: 30px"></image>';
                    } }, { data: "genToday", title: $.getI18n('genToday') + '(度)', width: '10%' }, { data: "charToday", title: $.getI18n('chargeToday') + '(度)', width: '10%' }, { data: "disCharToday", title: $.getI18n('dischargeToday') + '(度)', width: '10%' }, { data: "batCapacity", title: $.getI18n('batCapacity') + '(度)', width: '10%' }, { data: "soc", title: 'SOC', width: '5%' }, { data: "contact", title: $.getI18n('contacts'), width: '8%' }, { data: "userTel", title: $.getI18n('telephone'), width: '8%' }],
                "order": [
                    // [2, "desc"]
                ],
                'columnDefs': [{
    ...
    //展开数据曲线
    linePowerData: function linePowerData(datas, id) {
        var xData = datas.xData;
        var option = {
            // tooltip:{
            //     // trigger:'axis',
