...
var realTimeInfo = {
    ...
    //获取电站实时信息
    getPlantsRealTimeInfo: function getPlantsRealTimeInfo(_this) {
        //基础信息
        ...
        function getPlantsRealTimeInfo() {
            ...
            $.http.POST('/monitor/getTodayInfo.do', { tokenId: Cookies.getCook('tokenId') }, function (res) {
                ...
                if (JSON.stringify(res.body) == "{}") {
                    ...
                    var genDay = App.convertUnit("kilowatt", body.genDay, 6);
                    var profitDay = App.convertUnit("rmb", body.profitDay, 6);
    ...
    //获取当前时间
    drawWeather: function drawWeather(data) {
    ...
    //光储储能今日信息
    getTodayData: function getTodayData(_this) {
        //基础信息
        getTodayInfo();
        function getTodayInfo() {
            ...
            $.http.POST('/monitor/getTodayChargeEle.do', { tokenId: Cookies.getCook('tokenId'), plantType: Cookies.getCook('plantType') }, function (res) {
                ...
                if (JSON.stringify(res.body) == "{}") {
                    ...
                    var genDay = App.convertUnit("kilowatt", body.genDay, 6);
                    var charge = App.convertUnit("kilowatt", body.charge, 6);
                    var disCharge = App.convertUnit("kilowatt", body.disCharge, 6);
