...
var LargeScreenRender = {
    ...
    //公司基本信息
    basicCompany: function basicCompany() {
        var timer = '';
        var _this = this;
    ...
    powerIncome: function powerIncome(datas) {
    ...
    popWinBasicInfo: function popWinBasicInfo(datas) {
        var _this = this;
        ...
        switch (date.getDay()) {
            case 0:
                week = $.getI18n("screen.sunday");break;
            case 1:
                week = $.getI18n("screen.monday");break;
            case 2:
                week = $.getI18n("screen.tuesday");break;
            case 3:
                week = $.getI18n("screen.wednesday");break;
            case 4:
                week = $.getI18n("screen.thursday");break;
            case 5:
                week = $.getI18n("screen.friday");break;
            case 6:
                week = $.getI18n("screen.saturday");break;
        }
    ...
    //累计发电量定时刷新
    totalGen: function totalGen(data) {
    ...
    setTime: function setTime(time) {
        ...
        _this.timeInter = setInterval(function () {
            ...
            $('.screenTime').find('i').eq(0).text(month).end().eq(1).text(day).end().end().end().find('b#scT').text(year).end();
    ...
    //发电量文字
    powerWord: function powerWord(data) {
    ...
    //发电量图表
    powerInfo: function powerInfo(datas) {
    ...
    //地图业务
    MapBusiness: function MapBusiness() {
        var _this = this;
        var highlight = '';
        ...
        var map;
        MapContain(mapId);
        var appendContent = '    <div id="popDetailWin" class="popDetailWin" >\n' + '        <a class="closebtn" id="popwin-close"><img src="/images/largeScreen/close.png"></a>\n' + '        <div class="basic-info clearfix">\n' + '            <div class="basic-info-pic" id="largeCarousel">' + '               <div class="pic-container">' + '                   <div class="cameraImg" id="toCamera" style="z-index:99"></div>' + '<ol class="carousel-indicators"></ol>' + '<div class="carousel-inner carouselBox"></div>' +
                ...
                * */
                ...
                function exuteSerach() {
                    $.http.POST('/screen/getAllPlant.do', { tokenId: Cookies.getCook('tokenId') }, function (result) {
                        ...
                        L.DomEvent.off($('.search-button').get(0), 'click', searchRes._handleSubmit, searchRes);
                        searchRes._handleSubmit = function () {
    ...
    //渲染功率KPI
    winCurveKpi: function winCurveKpi(datas) {
        var xData = datas.xData,
            yData1 = datas.yData1,
            yData2 = datas.yData2;
            ...
            series: [{
                ...
                axisLine: {
                    ...
                    lineStyle: {
                        width: 15,
                        shadowBlur: 0,
                        color: [[0.2, '#2DC6C8'], [0.8, '#5AB1EF'], [1, '#D87A80']]
                    }
                },
                type: 'gauge',
                precision: 0,
    ...
    cameraWin: function cameraWin(obj) {
        /*var ca = [];
        ...
        $('#cameraList a').unbind().on('click', function () {
            ...
            $.http.POST('/device/getLiveHLS.do', { tokenId: Cookies.getCook('tokenId'), id: $(this).attr('attrid') }, function (res) {
                ...
                $('#videoMain').html('<video id="mapPlayer" poster="/images/cameraLoading.gif" autoplay controls playsInline webkit-playsinline>\n' + '                <source id="rtmpUrl" src="' + res.body.rtmp + '" />\n' + '                <source id="hlsUrl" src="' + res.body.hls + '" type="application/x-mpegURL" />\n' + '            </video>');
                $('#mapPlayer').show();
    ...
    cameraHisWin: function cameraHisWin(obj) {
