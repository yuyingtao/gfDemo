...
var IOPageRender = {
    ...
    AlarmUtil:function () {
        ...
        $('.alarmType').unbind().on('click',function () {
            // 定时刷新
            !! _this.tableInter && clearInterval( _this.tableInter);
        ...
        $('#alarmList').on( 'click', 'tbody tr', function (e) {
            ...
            if(_this.curId !== _this.table.api().row( this ).data().id){
                _this.curId =  _this.table.api().row( this ).data().id
