...
var RoleRender = {
    ...
    Render: function Render() {
        ...
        $("#jurisdictionList").on("click", "#saveModify", function () {
            ...
            if (!treeObj.getCheckedNodes().length) {} else {
    ...
    //设置树权限列表
    getAuthorityZtree: function getAuthorityZtree(_this, roleId) {
