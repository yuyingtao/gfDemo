...
var EnterpriseReder = {
    ...
    //获取企业信息
    getSystemBasic: function getSystemBasic(_this, orgId) {
    ...
    //系统logo上传
    uploadLogoImg: function uploadLogoImg(_this, ids) {
    ...
    //大屏logo上传
    uploadBigImg: function uploadBigImg(_this, ids) {
    ...
    //修改企业信息
    updateSystemBasic: function updateSystemBasic(_this) {
    ...
    //修改企业图片
    updateOrgPhoto: function updateOrgPhoto(_this, ids) {
    ...
    //修改宣传图片
    updatePropagandaPhoto: function updatePropagandaPhoto(ids, _this) {
        var pic = [];
        pic.push($(ids[0])[0].files[0]);
