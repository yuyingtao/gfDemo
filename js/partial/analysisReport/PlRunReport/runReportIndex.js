...
var runReportIndexRender = {
    ...
    initTime: function initTime(_this) {
        ...
        $('#dimenTime').unbind().on('click', function () {
            ...
            switch (limit) {
                case "month":
                    WdatePicker({ el: "dimenTime", readOnly: true, minDate: limitTime, dateFmt: 'yyyy/M', isShowClear: false, maxDate: '%y-%M' });break;
                case "year":
                    WdatePicker({ el: "dimenTime", readOnly: true, minDate: limitTime, dateFmt: 'yyyy', isShowClear: false, maxDate: '%y' });break;
            }
        });
    },
    //切换年月维度
